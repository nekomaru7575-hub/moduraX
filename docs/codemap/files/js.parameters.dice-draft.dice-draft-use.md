...
|---:|---|---|---:|:-:|
| 35 | runDiceDraftUse | `runDiceDraftUse({ spec, skillName, mode = 'all', targetValue = null, token, dispatch, getToken, getEffectiveParameterValue, generateBuffId, chatCommand = '', notify = (message) => alert(message) })` | 142 | ✓ |
