...
| 535 | const | whoIsDediDevi | `whoIsDediDevi` | 会話用の選択肢たち |
| 546 | const | howToEraceYou | `howToEraceYou` |  |
| 565 | fn | buildHelpRoot | `buildHelpRoot(activePlugin)` | この部屋で出すヘルプのルート層を組む。 |
...
|---:|---|---|---:|:-:|
| 565 | buildHelpRoot | `buildHelpRoot(activePlugin)` | 8 | ✓ |
