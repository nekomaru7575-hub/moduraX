 ...
 * Coreが判定をBCDiceへ送る前に呼ぶ（js/parameters/registry.jsのapplyPluginCheckRoll）。
 * ここで付けたDBのバフは {DB} の展開に間に合う＝振るダイスの数へ反映される。
 *
 * 【判定は止めない】ここで何をしても、しなくても、判定はこの後そのまま振られる。だから
 * ブーケが足りないときもalertで止めず、返す1行に理由を書いて通す。
 *
