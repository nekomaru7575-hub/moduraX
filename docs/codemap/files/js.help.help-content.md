...
| 536 | const | whoIsDediDevi | `whoIsDediDevi` | 会話用の選択肢たち |
| 547 | const | howToEraceYou | `howToEraceYou` |  |
| 566 | fn | buildHelpRoot | `buildHelpRoot(activePlugin)` | この部屋で出すヘルプのルート層を組む。 |
...
|---:|---|---|---:|:-:|
| 566 | buildHelpRoot | `buildHelpRoot(activePlugin)` | 8 | ✓ |
